            ...
            with ProcessPoolExecutor(max_workers=300) as executor:
                ...
                for future in futures:
                    ...
                    if package_name:
                        ...
                        print(f"=> Problem scanning {package_name}: {output}")

    if excluded_packages:
        print("=> Following packages already been scanned and excluded from scan list::\n")
        for package_name in excluded_packages:
            print(package_name)

    if problematic_scans:
        print("=> Following packages were problematic:\n")
